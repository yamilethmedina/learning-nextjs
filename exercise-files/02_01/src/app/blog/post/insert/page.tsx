...
export default function Page() {
  ...
  const PROMPT = "You are a creative blog writer. Write a 50-word blog post about the title below."
    ...
    <div className="bg-white p-8 rounded shadow">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          {generating && <p className='text-orange-700 my-1'>Generating content...</p>}
